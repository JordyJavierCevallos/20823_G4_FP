...
// Limpia pantalla según sistema operativo
...
void registrarIngreso(Vehiculo parqueadero[], int *cantidad) {
    ...
    do {
        ...
        if (!validarPlaca(nuevo.placa)) {
            printf("\033[1;31mPlaca invalida. Debe tener 3 letras y 4 numeros.\033[0m\n");
            limpiarBuffer();
        }
    ...
    do {
        ...
        if (!esTextoValido(nuevo.marca)) {
            printf("\033[1;31mMarca invalida. Solo se permiten letras.\033[0m\n");
            limpiarBuffer();
        }
    ...
    do {
        ...
        if (!esTextoValido(nuevo.color)) {
            printf("\033[1;31mColor invalido. Solo se permiten letras.\033[0m\n");
            limpiarBuffer();
        }
    ...
    do {
        ...
        if (!esHoraValida(nuevo.horaEntrada)) {
            printf("\033[1;31mHora de entrada invalida. Formato correcto HH:MM, rango 00:00 a 23:59.\033[0m\n");
            limpiarBuffer();
        }
    ...
    printf("\033[1;32mVehiculo registrado exitosamente.\033[0m\n");
}
        ...
        if (strcmp(parqueadero[i].placa, placa) == 0 && parqueadero[i].precioPagado == 0.0) {
            do {
                ...
                if (!esHoraValida(parqueadero[i].horaSalida)) {
                    printf("\033[1;31mHora de salida invalida. Formato correcto HH:MM, rango 00:00 a 23:59.\033[0m\n");
                    limpiarBuffer();
                }
            ...
            if (minutosSalida < minutosEntrada) {
                printf("\033[1;31mLa hora de salida no puede ser anterior a la hora de entrada.\033[0m\n");
            ...
            printf("\033[1;32mPrecio a pagar\033[0m: \033[1;31m$%.2f\033[0m\n", parqueadero[i].precioPagado);
            return;
        }
    }
    printf("\033[1;31mVehiculo no encontrado o ya salio.\033[0m\n");
}

void mostrarVehiculos(Vehiculo parqueadero[], int cantidad) {
    printf("\033[1;35m--- Lista de Vehiculos ---\033[0m\n");
    ...
    for (int i = 0; i < cantidad; i++) {
       printf("\033[1;33mPlaca:\033[0m %s | \033[1;36mMarca:\033[0m %s | \033[1;35mColor:\033[0m %s | \033[1;34mEntrada:\033[0m %s | \033[1;34mSalida:\033[0m %s | \033[1;32mPagado:\033[0m $%.2f\n",
               parqueadero[i].placa,
               parqueadero[i].marca,
               parqueadero[i].color,
...
void buscarVehiculo(Vehiculo parqueadero[], int cantidad) {
    if (cantidad == 0) {
        printf("\033[1;31mNo hay vehiculos en su parqueadero.\033[0m\n");
        return;
    }
    ...
    printf("\033[1;31mVehiculo no encontrado.\033[0m\n");
}
    ...
    do {
        ...
        for (int i = 0; i < cantidad; i++) {
            if (strcmp(parqueadero[i].placa, placa) == 0) {
                ...
                printf("\033[1;32mVehiculo modificado correctamente.\033[0m\n");
                break;  // salir del for
            }
        }

        if (!encontrado) {
            printf("\033[1;31mVehiculo no encontrado con la placa ingresada. Intente nuevamente.\033[0m\n");
        }
...
void finalizarDia(Vehiculo parqueadero[], int cantidad) {
    ...
    if (archivo == NULL) {
        printf("\033[1;31mError al crear el archivo de resumen.\033[0m\n");
        return;
    }
    ...
    printf("\033[1;35m--- Cierre del Dia ---\033[0m\n");
    printf("\033[0;93mFecha:\033[0m \033[1;31m%s\033[0m\n", fechaTexto);
    ...
    printf("\033[1;32mTotal recaudado: \033[0m\033[1;31m$%.2f\033[0m\n", total);
...
void mostrarMenu() {
    printf("\033[1;34m--- MENU PARQUEADERO ---\033[0m\n");
...
int main() {
    ...
    do {
        ...
        while (scanf("%d", &opcion) != 1) {
            printf("\033[1;31mEntrada invalida. Intente de nuevo.\033[0m\n");
            limpiarBuffer();
            mostrarMenu();
        }
        ...
        switch (opcion) {
            ...
            case 6:
                ...
                break;
            case 7:
                printf("\033[1;33mSaliendo del sistema...\033[0m\n");
                break;
            default:
