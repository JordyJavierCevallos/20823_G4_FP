...
int main() {
   ...
   printf("Ingrese el valor minimo : ");                           //RF01 - Configuracion dinamica del rango
    scanf("%d", &minimo);
    ...
    do {                                                                          // RF02 - Configuracion dinamica de intentos
    ...
    for (int i = 0; i < intentosPermitidos; ) {
        ...
        if (intento < minimo || intento > maximo) {                // RF03 - Validación de rango y duplicados
            printf("Numero fuera del rango.\n");
            continue;
        }
        
        int repetido = 0;                                      // RF03 - Validación de rango y duplicados
